document.getElementById("button1").addEventListener("click", function () {
    ...
    document.getElementById("paragraph").innerHTML = "In the brisk months of October 2021, a game was introduced to the world, WORDLE. This simple game captivated everyone from old to young, student to professor. Everyone in an English speaking country has heard the name WORDLE. When I got wind of this new free minigame I gave it a try only to see I suck at it. The problem had shown itself. I knocked on my brother's room and gave him a challenge, design a program that can help you beat wordle every time. He obliged and we were off, now this wasn't our first time, we had had many challenges like this before when we tried to outcode each other on a website called Scratch by MIT. You can try the WORDLE game with the link below!";
...
document.getElementById("button2").addEventListener("click", function () {
    ...
    document.getElementById("paragraph").innerHTML = "I made the first version in 2022 around the same time as my brother, although I won the contest because my version allowed the user to input data without having to input all previous data. This was achieved by making a display, where the user could input information in different sections to indicate the hints WORDLE gave them. At the time of making the first version, there was this meme about people adding to the end of a word to mean the opposite. If you are reading this you are didn't, hence WORDLEn't. You can try this version for yourself, with the link below!";
